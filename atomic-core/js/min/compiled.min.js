...
function sidebar(){var s=$(".atoms-side"),i=($(".atoms-main"),$(".atoms-side_show")),t=$(".cat-form-group");i.css("left","-100px"),t.css("left","0"),s.css("left","0"),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20)}function noSidebar(){var s=$(".atoms-side"),i=$(".atoms-main"),t=$(".atoms-side_show"),d=$(".cat-form-group");t.css("left","10px"),d.css("left","-500px"),s.css("left","-500px"),i.css("padding-left","20px").css("width","100%")}$(".atoms-side_hide").click(function(){noSidebar()}),$(".atoms-side_show").click(function(){sidebar()}),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20);
function actionsWidth(){$side=$(".atoms-side"),$body=$("body"),$action=$(".ad_js-actionDrawer"),sideWidth=$($side).outerWidth(),bodyWidth=$("body").outerWidth(),$action.css("width",bodyWidth-sideWidth-1)}actionsWidth(),$(window).resize(function(){actionsWidth()});var actionOpen=[{elements:$(".ad_js-actionDrawer"),properties:{right:"auto"},options:{duration:300}}],actionClose=[{elements:$(".ad_js-actionDrawer"),properties:{right:"-100%"},options:{duration:300}}];$(".ad_js-actionOpen").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionOpen)}),$(".ad_js-actionClose").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionClose)}),$("body").on("click",".ad_js-actionOpen",function(){$(".ad_errorBox").remove()}),$("body").on("click",".ad_js-errorBox__close",function(){$(".ad_errorBox").fadeOut(200)}),$(".ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$("#form-create-category").submit(function(e){reDirect=$("input[name=dirName]").val();var r={dirName:$("input[name=dirName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/create-category.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-category").submit(function(e){var r={dirName:$("input[name=inputNameDelete]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/delete-category.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/index.php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-create-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),fileCreateName:$("input[name=fileCreateName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/create.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-rename-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),oldName:$("input[name=oldName]").val(),renameFileName:$("input[name=renameFileName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/file-rename.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),dirVal=$("#form-file-move input[name=compDir]").val(),$("#newDir option[value="+dirVal+"]").remove(),$("#form-file-move").submit(function(e){reDirect=$("#newDir").val();var r={compDir:$("input[name=compDir]").val(),newDir:$("#newDir").val(),fileMoveName:$("input[name=fileMoveName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/file-move.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),deleteFileName:$("input[name=deleteFileName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/delete.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})});