...
var $comp=$(".component");$comp.wrapInner('<div class="source"></div>'),$(".markDown-display").append('<div class="atoms-code-example"><pre><code class="dest language-markup"></code></pre></div>');var ls=$(".compWrap");ls.each(function(){var a=$(this).find(".source").html(),e=$(this).find(".dest");e.text(a)});
