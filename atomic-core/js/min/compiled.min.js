...
var sideOpen=[{elements:$(".atoms-side_show"),properties:{left:"-100%"},options:{duration:300}},{elements:$(".atoms-side"),properties:{translateX:"0"},options:{duration:200}},{elements:$(".atoms-main"),properties:{paddingLeft:"282px"},options:{duration:200,sequenceQueue:!1}}];$(".atoms-side_show ").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(sideOpen)});var sideClose=[{elements:$(".atoms-side"),properties:{translateX:"-100%"},options:{duration:200}},{elements:$(".atoms-main"),properties:{paddingLeft:"40px"},options:{duration:200,sequenceQueue:!1}},{elements:$(".atoms-side_show"),properties:{left:"7px"},options:{duration:300}}];$(".js-hideSide").on("click",function(){$.Velocity.RunSequence(sideClose)});var titleClose=[{elements:$(".compTitle"),properties:{height:"0",opacity:"0"},options:{duration:200,sequenceQueue:!1}}],codeOpen=[{elements:$(".atoms-code-example"),properties:{height:"100%",opacity:"1"},options:{duration:200,sequenceQueue:!1}}];$(".js-hideTitle").on("click",function(){"0px"==$(".compTitle").css("height")?($(".compTitle").animateAuto("height",200,"linear"),$(".compTitle").velocity({opacity:"1"},{duration:200})):$.Velocity.RunSequence(titleClose)});var codeClose=[{elements:$(".atoms-code-example"),properties:{height:"0",opacity:"0"},options:{duration:200,sequenceQueue:!1}}],codeOpen=[{elements:$(".atoms-code-example"),properties:{height:"100%",opacity:"1"},options:{duration:200,sequenceQueue:!1}}];$(".js-hideCode").on("click",function(){"0px"==$(".atoms-code-example").css("height")?($(".atoms-code-example").animateAuto("height",200,"linear"),$(".atoms-code-example").velocity({opacity:"1"},{duration:200})):$.Velocity.RunSequence(codeClose)}),jQuery.fn.animateAuto=function(e,t,o){var i,n,s;return this.each(function(a,p){p=jQuery(p),i=p.clone().css({height:"auto",width:"auto"}).appendTo("body"),n=i.css("height"),s=i.css("width"),i.remove(),"height"===e?p.animate({height:n},t,o):"width"===e?p.animate({width:s},t,o):"both"===e&&p.animate({width:s,height:n},t,o)})};
