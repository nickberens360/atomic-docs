...
$(".js-hideCode").on("click",function(){"0"==$(".atoms-code-example").css("opacity")?($(this).css("color","#fff"),$(".atoms-code-example").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".atoms-code-example").velocity({opacity:"0"},{duration:200}))});
...
$(".js-hideTitle").on("click",function(){"0"==$(".compTitle").css("opacity")?($(this).css("color","#fff"),$(".compTitle").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".compTitle").velocity({opacity:"0"},{duration:200}))});
