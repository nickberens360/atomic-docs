...
$(".cat-form-group .fa").click(function(){$(this).toggleClass("fa-minus-square-o fa-plus-square-o"),$(".js-showContent").slideToggle()}),$(".aa_dir__dirNameGroup .aa_dir__dirNameGroup__icon").click(function(){$(this).parent().next().slideToggle("fast"),$(this).toggleClass("fa-folder-o fa-folder-open-o ")}),$(".active .aa_dir__dirNameGroup__icon").removeClass("fa-folder-o").addClass("fa-folder-open-o"),$(document).ready(function(){var a=window.location.href.split("#")[0];$('.aa_fileSection a[href^="#"]').each(function(){var o=$(this),e=o.attr("href");o.attr("href",a+e)})});
function showSideBar(){$(".atoms-side").velocity({translateX:"0"},{duration:200}),$(".atoms-main").velocity({paddingLeft:"282px"},{duration:200})}function hideSideBar(){$(".atoms-side").velocity({translateX:"-100%"},{duration:200}),$(".atoms-main").velocity({paddingLeft:"40px"},{duration:200})}$(".js-showSide").on("click",function(i){i.preventDefault(),showSideBar()}),$(".js-hideSide").on("click",function(i){i.preventDefault(),hideSideBar()});

function actionsWidth(){$side=$(".atoms-side"),$body=$("body"),$action=$(".aa_js-actionDrawer"),sideWidth=$($side).outerWidth(),bodyWidth=$("body").outerWidth(),$action.css("width",bodyWidth-sideWidth-1)}actionsWidth(),$(window).resize(function(){actionsWidth()});var actionOpen=[{elements:$(".aa_js-actionDrawer"),properties:{right:"auto"},options:{duration:300}}],actionClose=[{elements:$(".aa_js-actionDrawer"),properties:{right:"-100%"},options:{duration:300}}];$(".aa_js-actionOpen").on("click",function(o){o.preventDefault(),$.Velocity.RunSequence(actionOpen)}),$(".aa_js-actionClose").on("click",function(o){o.preventDefault(),$.Velocity.RunSequence(actionClose)}),$("body").on("click",".aa_js-actionOpen",function(){$(".aa_errorBox").remove()}),$("body").on("click",".aa_js-errorBox__close",function(){$(".aa_errorBox").fadeOut(200)});
$(".aa_fileSection__file .aa_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$(".js-showHide-trigger").click(function(){$(".showHide").slideUp(250),$(".fa-plus").removeClass("fa-plus-is-rotated"),$(this).next().is(":hidden")&&($(this).next().slideDown(250),$(this).find(".fa-plus").addClass("fa-plus-is-rotated"))}),$(".bgColor").spectrum({allowEmpty:!0,preferredFormat:"hex",showInput:!0}),$("#form-rename-file").submit(function(e){reDirect=$("input[name=compDir]").val();var a={compDir:$("input[name=compDir]").val(),oldName:$("input[name=oldName]").val(),renameFileName:$("input[name=renameFileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/file-rename.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),notesTarget=$("input[name=fileMoveName]").val(),notesContent=$(".atoms-main #"+notesTarget).next().text(),$("input[name=compNotes]").val(notesContent),colorTarget=$("input[name=fileMoveName]").val(),colorContent=$("#"+colorTarget).parent().find(".component").attr("style"),console.log(colorContent),colorContent=colorContent.split(":").pop(),colorContent.slice(0,-1),$("input[name=bgColor]").val(colorContent),dirVal=$("#form-file-move input[name=compDir]").val(),console.log(dirVal),$("#newDir option[value="+dirVal+"]").remove(),dirCount=$("#newDir option").size(),1>dirCount&&$("#form-file-move").parent().html("There are no catgories to move to at this time."),$("#form-file-move").submit(function(e){reDirect=$("#newDir").val();var a={compDir:$("input[name=compDir]").val(),newDir:$("#newDir").val(),fileMoveName:$("input[name=fileMoveName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/file-move.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-file").submit(function(e){reDirect=$("input[name=compDir]").val();var a={compDir:$("input[name=compDir]").val(),deleteFileName:$("input[name=deleteFileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/delete.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),notesEditTarget=$("input[name=fileName]").val(),notesEditTarget=$(".atoms-main #"+notesTarget).next().text(),$("textarea[name=compNotesNew]").val(notesEditTarget),$("#form-rename-notes").submit(function(e){notesEditTarget=$("input[name=fileName]").val(),notesEditTarget=$(".atoms-main #"+notesTarget).next().text(),$("input[name=compNotes]").val(notesEditTarget),reDirect=$("input[name=compDir]").val();var a={compDir:$("input[name=compDir]").val(),fileName:$("input[name=fileName]").val(),bgColor:$("input[name=bgColor]").val(),compNotes:$("input[name=compNotes]").val(),compNotesNew:$("textarea[name=compNotesNew]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/notes-rename.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),colorTarget=$("input[name=fileMoveName]").val(),$("#form-change-bgColor").submit(function(e){reDirect=$("input[name=compDir]").val();var a={compDir:$("input[name=compDir]").val(),fileName:$("input[name=fileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val(),bgColorNew:$("input[name=bgColorNew]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/bgcolor-rename.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})}),$(".aa_addFileItem .aa_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$(".bgColor").spectrum({allowEmpty:!0,preferredFormat:"hex",showInput:!0}),$("#form-create-file").submit(function(e){reDirect=$("input[name=compDir]").val();var a={compDir:$("input[name=compDir]").val(),fileCreateName:$("input[name=fileCreateName]").val(),compNotes:$("textarea[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/create.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})}),$(".catAdd .aa_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$("#form-create-category").submit(function(e){reDirect=$("input[name=dirName]").val();var a={dirName:$("input[name=dirName]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/create-category.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-category").submit(function(e){var a={dirName:$("input[name=inputNameDelete]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/delete-category.php",data:a,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/index.php":(e.errors.exists&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)),e.errors.name&&($(".aa_errorBox__message").html(""),$(".aa_actionDrawer").prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".aa_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})});
...
$(".atoms-code-example")[0]&&$(".js-hideCode").on("click",function(){"0"==$(".compCodeBox").css("opacity")?($(this).css("color","#fff"),$(".compCodeBox").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".compCodeBox").velocity({opacity:"0"},{duration:200}))});
$(".compNotes").is(":empty")||$(".js-hideNotes").on("click",function(){"0"==$(".compNotes").css("opacity")?($(this).css("color","#fff"),$(".compNotes").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".compNotes").velocity({opacity:"0"},{duration:200}))});
$(".atoms-code-example")[0]&&$(".js-hideTitle").on("click",function(){"0"==$(".compTitle").css("opacity")?($(this).css("color","#fff"),$(".compTitle").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".compTitle").velocity({opacity:"0"},{duration:200}))});
var navOpen=[{elements:$(".atoms-side"),properties:{top:"0"},options:{duration:200}}],navClose=[{elements:$(".atoms-side"),properties:{top:"-100%"},options:{duration:200}}];$(".atoms-side_show-small").on("click",function(){"0px"==$(".atoms-side").css("top")?$.Velocity.RunSequence(navClose):$.Velocity.RunSequence(navOpen)});
