...
function sidebar(){var s=$(".atoms-side"),i=($(".atoms-main"),$(".atoms-side_show")),t=$(".cat-form-group");i.css("left","-100px"),t.css("left","0"),s.css("left","0"),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20)}function noSidebar(){var s=$(".atoms-side"),i=$(".atoms-main"),t=$(".atoms-side_show"),d=$(".cat-form-group");t.css("left","10px"),d.css("left","-500px"),s.css("left","-500px"),i.css("padding-left","20px").css("width","100%")}$(".atoms-side_hide").click(function(){noSidebar()}),$(".atoms-side_show").click(function(){sidebar()}),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20);
function actionsWidth(){$side=$(".atoms-side"),$body=$("body"),$action=$(".ad_js-actionDrawer"),sideWidth=$($side).outerWidth(),bodyWidth=$("body").outerWidth(),$action.css("width",bodyWidth-sideWidth-1)}actionsWidth(),$(window).resize(function(){actionsWidth()});var actionOpen=[{elements:$(".ad_js-actionDrawer"),properties:{right:"auto"},options:{duration:300}}],actionClose=[{elements:$(".ad_js-actionDrawer"),properties:{right:"-100%"},options:{duration:300}}];$(".ad_js-actionOpen").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionOpen)}),$(".ad_js-actionClose").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionClose)}),$(".ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){function t(){$("form input, form select").removeClass("inputTxtError"),$("label.error").remove()}function t(){$("form input, form select").removeClass("inputTxtError"),$("label.error").remove()}$("#js_actionDrawer__content").html($(e));var e={};$(document).ready(function(){$(".form1").on("click",function(){t();var o="/atomic-docs/atomic-core/partial-mngr/create-category.php";return $.each($("input, select"),function(t,o){"submit"!==o.type&&(e[o.name]=o.value)}),$.ajax({dataType:"json",type:"POST",url:o,data:e,success:function(e){if(e===!0)return $("#form1").submit(),!1;$.each(e,function(e,t){console.log(e+" => "+t);var o='<label class="error" for="'+e+'">'+t+"</label>";$(".test").addClass("inputTxtError").after(o)});var t=Object.keys(e);return $('input[name="'+t[0]+'"]').focus(),!1},error:function(){console.log("there was a problem checking the fields")}}),!1})});var e={};$(document).ready(function(){$(".form2").on("click",function(){t();var o="/atomic-docs/atomic-core/partial-mngr/create-category.php";return $.each($("#form2 input, #form2 select"),function(t,o){"submit"!==o.type&&(e[o.name]=o.value)}),$.ajax({dataType:"json",type:"POST",url:o,data:e,success:function(e){if(e===!0)return $("#form2").submit(),!1;$.each(e,function(e,t){console.log(e+" => "+t);var o='<label class="error" for="'+e+'">'+t+"</label>";$(".test2").addClass("inputTxtError").after(o)});var t=Object.keys(e);return $('input[name="'+t[0]+'"]').focus(),!1},error:function(){console.log("there was a problem checking the fields")}}),!1})})},error:function(){alert("did not worked!")}})});