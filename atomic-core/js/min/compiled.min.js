...
$(".cat-form-group .fa").click(function(){$(this).toggleClass("fa-minus-square-o fa-plus-square-o"),$(".js-showContent").slideToggle()}),$(".ad_dir__dirNameGroup .ad_dir__dirNameGroup__icon").click(function(){$(this).parent().next().slideToggle("fast"),$(this).toggleClass("fa-folder-o fa-folder-open-o ")}),$(".active .ad_dir__dirNameGroup__icon").removeClass("fa-folder-o").addClass("fa-folder-open-o"),$(document).ready(function(){var o=window.location.href.split("#")[0];$('.ad_fileSection a[href^="#"]').each(function(){var a=$(this),e=a.attr("href");a.attr("href",o+e)})});
...
function actionsWidth(){$side=$(".atoms-side"),$body=$("body"),$action=$(".ad_js-actionDrawer"),sideWidth=$($side).outerWidth(),bodyWidth=$("body").outerWidth(),$action.css("width",bodyWidth-sideWidth-1)}actionsWidth(),$(window).resize(function(){actionsWidth()});var actionOpen=[{elements:$(".ad_js-actionDrawer"),properties:{right:"auto"},options:{duration:300}}],actionClose=[{elements:$(".ad_js-actionDrawer"),properties:{right:"-100%"},options:{duration:300}}];$(".ad_js-actionOpen").on("click",function(o){o.preventDefault(),$.Velocity.RunSequence(actionOpen)}),$(".ad_js-actionClose").on("click",function(o){o.preventDefault(),$.Velocity.RunSequence(actionClose)}),$("body").on("click",".ad_js-actionOpen",function(){$(".ad_errorBox").remove()}),$("body").on("click",".ad_js-errorBox__close",function(){$(".ad_errorBox").fadeOut(200)});
$(".ad_fileSection__file .ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$(".js-showHide-trigger").click(function(){$(".showHide").slideUp(250),$(".fa-plus").removeClass("fa-plus-is-rotated"),$(this).next().is(":hidden")&&($(this).next().slideDown(250),$(this).find(".fa-plus").addClass("fa-plus-is-rotated"))}),$(".bgColor").spectrum({allowEmpty:!0,preferredFormat:"hex",showInput:!0}),$("#form-rename-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),oldName:$("input[name=oldName]").val(),renameFileName:$("input[name=renameFileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/file-rename.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),notesTarget=$("input[name=fileMoveName]").val(),notesContent=$(".atoms-main #"+notesTarget).next().text(),$("input[name=compNotes]").val(notesContent),colorTarget=$("input[name=fileMoveName]").val(),colorContent=$("#"+colorTarget).parent().find(".component").attr("style"),console.log(colorContent),colorContent=colorContent.split(":").pop(),colorContent.slice(0,-1),$("input[name=bgColor]").val(colorContent),dirVal=$("#form-file-move input[name=compDir]").val(),$("#newDir option[value="+dirVal+"]").remove(),dirCount=$("#newDir option").size(),1>dirCount&&$("#form-file-move").remove(),$("#form-file-move").submit(function(e){reDirect=$("#newDir").val();var r={compDir:$("input[name=compDir]").val(),newDir:$("#newDir").val(),fileMoveName:$("input[name=fileMoveName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/file-move.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),deleteFileName:$("input[name=deleteFileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/delete.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),notesEditTarget=$("input[name=fileName]").val(),notesEditTarget=$(".atoms-main #"+notesTarget).next().text(),$("textarea[name=compNotesNew]").val(notesEditTarget),$("#form-rename-notes").submit(function(e){notesEditTarget=$("input[name=fileName]").val(),notesEditTarget=$(".atoms-main #"+notesTarget).next().text(),$("input[name=compNotes]").val(notesEditTarget),reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),fileName:$("input[name=fileName]").val(),bgColor:$("input[name=bgColor]").val(),compNotes:$("input[name=compNotes]").val(),compNotesNew:$("textarea[name=compNotesNew]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/notes-rename.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),colorTarget=$("input[name=fileMoveName]").val(),$("#form-change-bgColor").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),fileName:$("input[name=fileName]").val(),compNotes:$("input[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val(),bgColorNew:$("input[name=bgColorNew]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/bgcolor-rename.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})}),$(".ad_addFileItem .ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$(".bgColor").spectrum({allowEmpty:!0,preferredFormat:"hex",showInput:!0}),$("#form-create-file").submit(function(e){reDirect=$("input[name=compDir]").val();var r={compDir:$("input[name=compDir]").val(),fileCreateName:$("input[name=fileCreateName]").val(),compNotes:$("textarea[name=compNotes]").val(),bgColor:$("input[name=bgColor]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/create.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})}),$(".catAdd .ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$("#form-create-category").submit(function(e){reDirect=$("input[name=dirName]").val();var r={dirName:$("input[name=dirName]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/create-category.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/"+reDirect+".php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()}),$("#form-delete-category").submit(function(e){var r={dirName:$("input[name=inputNameDelete]").val()};$.ajax({type:"POST",url:"atomic-core/partial-mngr/delete-category.php",data:r,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="atomic-core/index.php":(e.errors.exists&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.exists+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)),e.errors.name&&($(".ad_errorBox__message").html(""),$(".ad_actionDrawer").prepend('<div class="ad_errorBox"><p class="ad_errorBox__message"><i class="fa fa-times ad_js-errorBox__close"></i> '+e.errors.name+"</p></div>").find(".ad_errorBox").hide().fadeIn(200)))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})});
