...
function sidebar(){var s=$(".atoms-side"),i=($(".atoms-main"),$(".atoms-side_show")),t=$(".cat-form-group");i.css("left","-100px"),t.css("left","0"),s.css("left","0"),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20)}function noSidebar(){var s=$(".atoms-side"),i=$(".atoms-main"),t=$(".atoms-side_show"),d=$(".cat-form-group");t.css("left","10px"),d.css("left","-500px"),s.css("left","-500px"),i.css("padding-left","20px").css("width","100%")}$(".atoms-side_hide").click(function(){noSidebar()}),$(".atoms-side_show").click(function(){sidebar()}),sideBarWidth=$(".atoms-side_hide").outerWidth(),$(".atoms-main").css("padding-left",sideBarWidth+20);
function actionsWidth(){$side=$(".atoms-side"),$body=$("body"),$action=$(".ad_js-actionDrawer"),sideWidth=$($side).outerWidth(),bodyWidth=$("body").outerWidth(),$action.css("width",bodyWidth-sideWidth-1)}actionsWidth(),$(window).resize(function(){actionsWidth()});var actionOpen=[{elements:$(".ad_js-actionDrawer"),properties:{right:"auto"},options:{duration:300}}],actionClose=[{elements:$(".ad_js-actionDrawer"),properties:{right:"-100%"},options:{duration:300}}];$(".ad_js-actionOpen").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionOpen)}),$(".ad_js-actionClose").on("click",function(e){e.preventDefault(),$.Velocity.RunSequence(actionClose)}),$(".ad_actionBtn").click(function(e){e.preventDefault(),$.ajax(this.href,{success:function(e){$("#js_actionDrawer__content").html($(e)),$("#form-create-category").submit(function(e){reDirect=$("input[name=dirName]").val(),$(".form-group").removeClass("has-error"),$(".help-block").remove();var o={dirName:$("input[name=dirName]").val()};$.ajax({type:"POST",url:"/atomic-docs/atomic-core/partial-mngr/create-category.php",data:o,dataType:"json",encode:!0}).done(function(e){console.log(e),e.success?window.location="/atomic-docs/atomic-core/"+reDirect+".php":e.errors.name&&($("#form-create-category .inputBtnGroup").addClass("has-error"),$("#form-create-category .inputBtnGroup").append('<div class="help-block">'+e.errors.name+"</div>"))}).fail(function(e){console.log(e)}),e.preventDefault()})},error:function(){}})});