<form id="form-create-category" class="aa_fileForm " action="/atomic-core/partial-mngr/create-category.php" method="post">
    <div class="formInputGroup">
        ...
        <div class="inputBtnGroup">
            <button class="aa_btn aa_btn-pos" type="submit" disabled="">Add</button>
            <div class="inputBtnGroup__inputWrap"><input type="text" class="form-control" name="dirName" disabled=""></div>
        </div>
    </div>
...
<form id="form-delete-category" class="aa_fileForm " action="/atomic-core/delete-category.php" method="post">
    <div class="formInputGroup">
        <div class="inputBtnGroup">
            ...
            <div class="inputBtnGroup__inputWrap"><input type="text" class="form-control" name="inputNameDelete" placeholder="Must type category name" disabled=""></div>
        </div>
    </div>
    <input type="hidden" name="deleteDir" value="deleteDir" disabled="">
</form>