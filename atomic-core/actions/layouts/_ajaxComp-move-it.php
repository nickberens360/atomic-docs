	...
	<form class="ad_fileForm " action="/atomic-docs/atomic-core/index.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          <label class="ad_label">Rename <span class="ad_label__file">move-it</span> component file</label>
      ...
      <input type="hidden" name="oldName" value="move-it"/>
    </form>
	<form class="ad_fileForm " action="/atomic-docs/atomic-core/index.php" method="post">
      <div class="formGroup">
        <div class="formInputGroup">
          <div class="inputBtnGroup">
            <label class="ad_label">Move <span class="ad_label__file">move-it</span> to...</label>
      ...
      <input type="hidden" name="compDir" value="layouts"/>
      <input type="hidden" name="fileName" value="move-it"/>
      <input type="hidden" name="moveFile" value="moveFile"/>
    </form>
    <form class="ad_fileForm " action="/atomic-docs/atomic-core/index.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          <label class="ad_label">Type <span class="ad_label__file">move-it</span> to delete the component files</label>
