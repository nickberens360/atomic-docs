<li class="ad_dir <?php if ($current_page == "test.php"){ echo "active "; }?>">
      ...
      <a class="ad_js-actionOpen ad_actionBtn" href="atomic-core/includes/_ajax-test.php">Add File</a>
		</div>
...
<li class="ad_dir <?php if ($current_page == "new.php"){ echo "active "; }?>">
      ...
      <a class="ad_js-actionOpen ad_actionBtn" href="atomic-core/includes/_ajax-new.php">Add File</a>
		</div>
		<ul class="ad_fileSection">
			<?php
				$orig = "../components/new";
