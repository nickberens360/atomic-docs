...
<label class="ad_label js-showHide-trigger"><span class="ad_label__file"><span class="fa fa-plus"></span> Rename</span> six component file</label>
<div class="showHide">
	<form id="form-rename-file"  class="ad_fileForm " action="/atomic-core/partial-mngr/file-rename.php" method="post">
      ...
      <input type="hidden" name="oldName" value="six"/>
    </form>
</div>
<label class="ad_label js-showHide-trigger">Change the <span class="ad_label__file">description</span> for six</label>
<div class="showHide">
   <form id="form-rename-notes"  class="ad_fileForm " action="/atomic-core/partial-mngr/notes-rename.php" method="post">
        ...
        <button class="ad_btn ad_btn-pos" type="submit" >Rename</button>
      <input type="hidden" name="compDir" value="layout"/>
      <input type="hidden" name="fileName" value="six"/>
      <input type="hidden" name="compNotes" value=""/>
    </form>
</div>
<label class="ad_label js-showHide-trigger"><span class="ad_label__file">Move</span>  six to...</label>
<div class="showHide">
	<form id="form-file-move" class="ad_fileForm " action="/atomic-core/partial-mngr/file-move.php" method="post">
      ...
      <input type="hidden" name="compDir" value="layout"/>
      <input type="hidden" name="fileMoveName" value="six"/>
      <input type="hidden" name="moveFile" value="moveFile"/>
      <input type="hidden" name="compNotes" value=""/>
    </form>
</div>
<label class="ad_label js-showHide-trigger">Type six to <span class="ad_label__file">delete</span> the component files</label>
<div class="showHide">
