...
<label class="ad_label js-showHide-trigger">Rename <span class="ad_label__file">more</span> component file</label>
<div class="showHide">
...
<label class="ad_label js-showHide-trigger">Change the description for <span class="ad_label__file">more</span></label>
<div class="showHide">
...
<div class="showHide">
	<form id="form-file-move" class="ad_fileForm " action="/atomic-core/partial-mngr/file-move.php" method="post">
      <div class="formGroup">
        <div class="formInputGroup">
          <div class="inputBtnGroup">
            <label class="ad_label">Move <span class="ad_label__file">more</span> to...</label>
...
<div class="showHide">
    <form id="form-delete-file" class="ad_fileForm " action="/atomic-core/partial-mngr/delete.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          <label class="ad_label">Type <span class="ad_label__file">more</span> to delete the component files</label>
