...
<label class="ad_label js-showHide-trigger">Rename <span class="ad_label__file">new</span> component file</label>
<div class="showHide">
...
<div class="showHide">
	<form id="form-file-move" class="ad_fileForm " action="/atomic-core/partial-mngr/file-move.php" method="post">
      <div class="formGroup">
        <div class="formInputGroup">
          <div class="inputBtnGroup">
            <label class="ad_label">Move <span class="ad_label__file">new</span> to...</label>
