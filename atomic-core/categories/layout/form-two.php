...
<label class="ad_label js-showHide-trigger">Rename <span class="ad_label__file">two</span> component file</label>
<div class="showHide">
	<form id="form-rename-file"  class="ad_fileForm " action="/atomic-core/partial-mngr/file-rename.php" method="post">
      ...
      <input type="hidden" name="oldName" value="two"/>
    </form>
</div>
<label class="ad_label js-showHide-trigger">Change the description for <span class="ad_label__file">two</span></label>
<div class="showHide">
   <form id="form-rename-notes"  class="ad_fileForm " action="/atomic-core/partial-mngr/notes-rename.php" method="post">
        ...
        <button class="ad_btn ad_btn-pos" type="submit" >Rename</button>
      <input type="hidden" name="compDir" value="layout"/>
      <input type="hidden" name="fileName" value="two"/>
      <input type="hidden" name="compNotes" value=""/>
    </form>
</div>
<label class="ad_label js-showHide-trigger">Move <span class="ad_label__file">two</span> to...</label>
<div class="showHide">
	<form id="form-file-move" class="ad_fileForm " action="/atomic-core/partial-mngr/file-move.php" method="post">
      ...
      <input type="hidden" name="compDir" value="layout"/>
      <input type="hidden" name="fileMoveName" value="two"/>
...
<div class="showHide">
    <form id="form-delete-file" class="ad_fileForm " action="/atomic-core/partial-mngr/delete.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          <label class="ad_label">Type <span class="ad_label__file">two</span> to delete the component files</label>
