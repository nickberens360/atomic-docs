...
<label class="ad_label js-showHide-trigger"><span class="fa fa-plus"></span> <span class="ad_label__file">Rename</span> logo</label>
<div class="showHide">
	<form id="form-rename-file"  class="ad_fileForm " action="/atomic-core/partial-mngr/file-rename.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          ...
          <div class="inputBtnGroup__inputWrap"><input type="text" class="form-control" name="renameFileName" value="logo" required></div>
        </div>     
      </div>
      <input type="hidden" name="compDir" value="molecules"/>
      <input type="hidden" name="rename" value="rename"/>
      <input type="hidden" name="oldName" value="logo"/>
    </form>
</div>
<label class="ad_label js-showHide-trigger"><span class="fa fa-plus"></span> Change the <span class="ad_label__file">description</span> for logo</label>
<div class="showHide">
...
<label class="ad_label js-showHide-trigger"><span class="fa fa-plus"></span> <span class="ad_label__file">Move</span>  logo</label>
<div class="showHide">
	<form id="form-file-move" class="ad_fileForm " action="/atomic-core/partial-mngr/file-move.php" method="post">
      ...
      <input type="hidden" name="compDir" value="molecules"/>
      <input type="hidden" name="fileMoveName" value="logo"/>
      <input type="hidden" name="moveFile" value="moveFile"/>
      <input type="hidden" name="compNotes" value=""/>
    </form>
</div>
<label class="ad_label js-showHide-trigger"><span class="fa fa-plus"></span> <span class="ad_label__file">Delete</span> logo</label>
<div class="showHide">
    <form id="form-delete-file" class="ad_fileForm " action="/atomic-core/partial-mngr/delete.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
          ...
          <div class="inputBtnGroup__inputWrap"><input type="text" class="form-control" name="deleteFileName" placeholder="Must type logo to delete"></div>
        </div>  
      </div>
      <input type="hidden" name="compDir" value="molecules"/>
