    ...
    //showAlpha: true
          ...
          $('#form-create-category').submit(function(event) {
            ...
            $.ajax({
              ...
              url 		: 'auto-core/partial-mngr/create-category.php', // the url where we want to POST
              ...
              .done(function(data) {
                ...
                if ( ! data.success) {
                  ...
                  //redirect here
                   window.location = 'auto-core/'+reDirect+'.php';
          ...
          $('#form-delete-category').submit(function(event) {
            ...
            $.ajax({
              type 		: 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url 		: 'auto-core/partial-mngr/delete-category.php', // the url where we want to POST
              data 		: formData, // our data object
              dataType 	: 'json', // what type of data do we expect back from the server
              encode 		: true
            })
              ...
              .done(function(data) {
                ...
                if ( ! data.success) {
                  ...
                  //redirect here
                   window.location = 'auto-core/index.php';
                  // usually after form submission, you'll want to redirect
                }
              })
              // using the fail promise callback
          ...
          $('#form-create-file').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/create.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
          ...
          $('#form-rename-file').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/file-rename.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
        ...
        //put notes value in compNotes hidden field
         ...
         notesContent = $('.auto-main #'+notesTarget).next().text();
        ...
        $('input[name=bgColor]').val(colorContent);
          ...
          $('#form-file-move').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/file-move.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
          ...
          $('#form-delete-file').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/delete.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
         ...
         notesEditTarget = $('.auto-main #'+notesTarget).next().text();
         ...
         $('textarea[name=compNotesNew]').val(notesEditTarget);
           ...
           $('#form-rename-notes').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/notes-rename.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
        ...
        /* colorContent = $('#'+colorTarget).parent().find('.component').attr( "style" );
         ...
         alert(colorContent);*/
           ...
           $('#form-change-bgColor').submit(function(event) {
            ...
            $.ajax({
              type    : 'POST', // define the type of HTTP verb we want to use (POST for our form)
              url     : 'auto-core/partial-mngr/bgcolor-rename.php', // the url where we want to POST
              data    : formData, // our data object
              dataType  : 'json', // what type of data do we expect back from the server
              encode    : true
            })
