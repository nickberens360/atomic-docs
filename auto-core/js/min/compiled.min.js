...
var $comp=$(".component");$comp.wrapInner('<div class="source"></div>'),$(".markup-display").append('<div class="auto-code-example"><pre><code class="dest language-markup"></code></pre></div>');var ls=$(".compWrap");ls.each(function(){var a=$(this).find(".source").html(),e=$(this).find(".dest");e.text(a)});
...
$(".auto-code-example")[0]&&$(".js-hideTitle").on("click",function(){"0"==$(".compTitle").css("opacity")?($(this).css("color","#fff"),$(".compTitle").velocity({opacity:"1"},{duration:200})):($(this).css("color","#247695"),$(".compTitle").velocity({opacity:"0"},{duration:200}))});
var navOpen=[{elements:$(".auto-side"),properties:{top:"0"},options:{duration:200}}],navClose=[{elements:$(".auto-side"),properties:{top:"-100%"},options:{duration:200}}];$(".auto-side_show-small").on("click",function(){"0px"==$(".auto-side").css("top")?$.Velocity.RunSequence(navClose):$.Velocity.RunSequence(navOpen)});
