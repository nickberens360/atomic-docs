...
<div class="showHide">
  <form id="form-rename-file"  class="ad_fileForm " action="/auto-core/partial-mngr/file-rename.php" method="post">
...
<div class="showHide">
   <form id="form-rename-notes"  class="ad_fileForm " action="/auto-core/partial-mngr/notes-rename.php" method="post">
...
<label class="ad_label js-showHide-trigger"><span class="fa fa-plus"></span> Change the <span class="ad_label__file">contextual background color</span> for '.$fileName.'</label>
<div class="showHide">
   <form id="form-change-bgColor"  class="ad_fileForm " action="/auto-core/partial-mngr/bgcolor-rename.php" method="post">
...
<div class="showHide">
  <form id="form-file-move" class="ad_fileForm " action="/auto-core/partial-mngr/file-move.php" method="post">
      <div class="formGroup">
        <div class="formInputGroup">
          <div class="inputBtnGroup">
...
<div class="showHide">
    <form id="form-delete-file" class="ad_fileForm " action="/auto-core/partial-mngr/delete.php" method="post">
      <div class="formInputGroup">
        <div class="inputBtnGroup">
