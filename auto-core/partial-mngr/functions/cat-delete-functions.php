...
function deleteautoCatDir($catName) { 
...
function deleteautoNavIncludeString($dirName)
{
   ...
   $includeString = "<?php include ('$dirName/navItem-$dirName.php');?>";		
	...
	$contents = file_get_contents('../categories/auto-nav.php');
	
	$contents = str_replace($includeString, "", $contents);
	$contents = file_put_contents('../categories/auto-nav.php', $contents);
