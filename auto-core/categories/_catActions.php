<form id="form-create-category" class="ad_fileForm " action="/auto-core/partial-mngr/create-category.php" method="post">
...
<form id="form-delete-category" class="ad_fileForm " action="/auto-core/delete-category.php" method="post" >
  <div class="formInputGroup">
    <div class="inputBtnGroup">
