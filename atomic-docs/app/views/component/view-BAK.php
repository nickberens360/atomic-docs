...
<div id="<?= $comp->name ?>" class="atomic-compWrap" data-atomiccomponent="<?= $comp->name ?>" data-atomiccat="<?= $catName ?>">
    <div class="atomic-compBar">
        <div class="atomic-compBarLeft">
            ...
            <div class="atomic-component__actions">
                ...
                <a href="/component/edit/<?= $compId ?>" class="material-icons ajax-link" data-target="panel" data-comp="<?= $comp->name ?>">settings</a>


                <!-- <a href="#" title="Edit Component"><i class="material-icons">settings</i></a>-->
    ...
    <div class="atomic-component js-atomic-component<?= $bgClass ?>" <?= $bgStyle ?>>
        ...
        <?php include FRONT . '/components/'.$catName.'/'.$comp->name.'.php'?>
    ...
    <div class="atomic-tabs">
        ...
        <form action="<?= \Base::instance()->alias('editComponentSource', ['compId' => $comp->componentId]); ?>" class="atomic-editorForm ajax-form">
                ...
                <div id="atomic-markup-tab" class="atomic-tabs__content atomic-tabs__current">
                    <div class="atomic-editor__wrap">
                        <div class="atomic-editor__inner">
                            ...
                            <div class="atomic-editor" id="atomic-editor-markup-<?= $comp->componentId ?>"><textarea><?php include FRONT . '/components/'.$catName.'/'.$comp->name.'.php'?></textarea></div>

                        </div>
                        <textarea name="atomic-markup-field" id="atomic-copy-target-markup-<?= $comp->componentId ?>" class="atomic-copy-target"><?php include FRONT . '/components/'.$catName.'/'.$comp->name.'.php'?></textarea>
                    </div>
                </div>
                ...
                <div id="atomic-styles-tab" class="atomic-tabs__content">
                    <div class="atomic-editor__wrap">
                        <div class="atomic-editor__inner">
                            ...
                            <div class="atomic-editor" id="atomic-editor-styles-<?= $comp->componentId ?>"><textarea><?php include FRONT . '/scss/'.$catName.'/_'.$comp->name.'.scss'?></textarea></div>
                        </div>
                        <textarea name="atomic-styles-field" id="atomic-copy-target-styles-<?= $comp->componentId ?>" class="atomic-copy-target"><?php include FRONT . '/scss/'.$catName.'/_'.$comp->name.'.scss'?></textarea>
                    </div>
                </div>
