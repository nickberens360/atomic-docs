...
<div class="atomic-tabs">
	<ul class="tabs atomic-tabs__tabs">
		...
		<li class="atomic-tabs__item" data-tab="atomic-output-tab"><i class="fa fa-eye" aria-hidden="true"></i> Output
		</li>
		<li class="atomic-tabs__item" data-tab="atomic-styles-tab"><i class="fa fa-css3" aria-hidden="true"></i> Styles
		</li>
		...
		<li class="atomic-tabs__item" data-tab="atomic-notes-tab"><i class="fa fa-comment" aria-hidden="true"></i> Notes
		</li>
	...
	<div class="atomic-editorForm">
		<div class="atomic-tabs__main">
			<div id="atomic-markup-tab" class="atomic-tabs__content atomic-tabs__current">
				<div class="atomic-editor__wrap">
					<div class="atomic-editor__inner">
						<textarea class="atomic-editor" id="atomic-editor-markup-<?= ($comp->componentId()) ?>"><?= (fileContents($comp->compFile($comp, 'markup'))) ?></textarea>
					</div>
					<textarea name="atomic-markup-field" id="atomic-copy-target-markup-<?= ($comp->componentId()) ?>" class="atomic-copy-target"><?= (fileContents($comp->compFile($comp, 'markup'))) ?></textarea>
				</div>
			</div>
			...
			<div id="atomic-styles-tab" class="atomic-tabs__content">
				<div class="atomic-editor__wrap">
					<div class="atomic-editor__inner">
						<textarea class="atomic-editor" id="atomic-editor-styles-<?= ($comp->componentId()) ?>"><?= (fileContents($comp->compFile($comp, 'styles'))) ?></textarea>
					</div>
					<textarea name="atomic-styles-field" id="atomic-copy-target-styles-<?= ($comp->componentId()) ?>" class="atomic-copy-target"><?= (fileContents($comp->compFile($comp, 'styles'))) ?></textarea>
				</div>
			</div>
			...
			<?php if ($comp->hasJs()): ?>
				<div id="atomic-js-tab" class="atomic-tabs__content">
					<div class="atomic-editor__wrap">
						<div class="atomic-editor__inner">
							<textarea class="atomic-editor" id="atomic-editor-js-<?= ($comp->componentId()) ?>"><?= (fileContents($comp->compFile($comp, 'js'))) ?></textarea>
						</div>
						<textarea name="atomic-js-field" id="atomic-copy-target-js-<?= ($comp->componentId()) ?>" class="atomic-copy-target"><?= (fileContents($comp->compFile($comp, 'js'))) ?></textarea>
					</div>
				</div>
			<?php endif; ?>
